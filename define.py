...
QUESTION_VISIABLE = [QUESTION_ENABLE, QUESTION_DISABLE]
QUESTION_ALL = [QUESTION_ENABLE, QUESTION_DISABLE, QUESTION_DELETE]
# 问答状态英文转为类型前端用
QUESTION_STATUS_FRONT_DESC = {
    QUESTION_ENABLE: 'enable',
    QUESTION_DISABLE: 'disable',
